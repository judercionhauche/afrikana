...
<div id="addProduct" class="content-section">
    ...
    <form action= "actions/edit_prod_actions.php" class= "addProductForm"  method ="POST" enctype="multipart/form-data">
        <div class="form-row">
        ...
        <div class="form-group">
            ...
            <textarea id="productDescription" name="productDescription" rows="4" value = <?php echo $product_description['productDescription'];?> required></textarea>
        </div>
        <div class="form-group">
